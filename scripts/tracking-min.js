...
!(function(t, r) {
    (t.tracking = t.tracking || {}),
      ...
      (tracking.track = function(t, r, n) {
        ...
        switch (t.nodeName.toLowerCase()) {
          ...
          case "video":
            return (
              n && n.camera && this.initUserMedia_(t, n),
    ...
    (function() {
      (tracking.Image = {}),
        (tracking.Image.blur = function(t, r, n, e) {
          ...
          for (
            var a = e / 2,
              i = Math.ceil(e) + (1 - Math.ceil(e) % 2),
              o = new Float32Array(i),
              c = (a + 0.5) / 3,
              s = c * c,
              g = 1 / Math.sqrt(2 * Math.PI * s),
              h = -1 / (2 * c * c),
              k = 0,
              f = Math.floor(i / 2),
              u = 0;
        ...
        (tracking.Image.computeIntegralImage = function(t, r, n, e, a, i, o) {
          ...
          for (var s = 0; s < n; s++)
            for (var g = 0; g < r; g++) {
              var h = s * r * 4 + 4 * g,
                k = ~~(0.299 * t[h] + 0.587 * t[h + 1] + 0.114 * t[h + 2]);
              if (
                (e && this.computePixelValueSAT_(e, r, s, g, k),
        ...
        (tracking.Image.grayscale = function(t, r, n, e) {
          for (
            var a = new Uint8ClampedArray(e ? t.length : t.length >> 2),
              i = 0,
              o = 0,
              c = 0;
            c < n;
            ...
            for (var s = 0; s < r; s++) {
              var g = 0.299 * t[o] + 0.587 * t[o + 1] + 0.114 * t[o + 2];
              (a[i++] = g),
        ...
        (tracking.Image.sobel = function(t, r, n) {
          ...
          for (
            var e = new Float32Array(r * n * 4),
              a = new Float32Array([-1, 0, 1]),
              i = new Float32Array([1, 2, 1]),
              o = this.separableConvolve(t, r, n, a, i),
              c = this.separableConvolve(t, r, n, i, a),
              s = 0;
            s < e.length;
            s += 4
          ) {
        ...
        (tracking.Image.equalizeHist = function(t, r, n) {
          for (
            var e = new Uint8ClampedArray(t.length), a = new Array(256), i = 0;
            i < 256;
            i++
          )
            a[i] = 0;
          ...
          for (var c = 255 / t.length, i = 0; i < t.length; i++)
            e[i] = (a[t[i]] * c + 0.5) | 0;
          return e;
        });
    })(),
    (function() {
      (tracking.ViolaJones = {}),
        ...
        (tracking.ViolaJones.detect = function(t, r, n, e, a, i, o, c) {
          var s,
            g = 0,
            h = [],
          ...
          for (
            var l = c[0], m = c[1], d = e * a, v = (d * l) | 0, p = (d * m) | 0;
            v < r && p < n;
  
          ) {
            for (var y = (d * i + 0.5) | 0, w = 0; w < n - p; w += y)
              for (var T = 0; T < r - v; T += y)
                (o > 0 && this.isTriviallyExcluded(o, s, w, T, r, v, p)) ||
        ...
        (tracking.ViolaJones.mergeRectangles_ = function(t) {
          for (
            var r = new tracking.DisjointSet(t.length), n = 0;
            n < t.length;
            n++
          )
    ...
    (function() {
      (tracking.Brief = {}),
        ...
        (tracking.Brief.getDescriptors = function(t, r, n) {
          for (
            var e = new Int32Array((n.length >> 1) * (this.N >> 5)),
              a = 0,
              i = this.getRandomOffsets_(r),
              o = 0,
              c = 0;
            c < n.length;
            c += 2
            ...
            for (
              ...
              t[i[g++] + s] < t[i[g++] + s] && (a |= 1 << (31 & h)),
                (h + 1) & 31 || ((e[o++] = a), (a = 0));
          return e;
        }),
        (tracking.Brief.match = function(t, r, n, e) {
          for (
            var a = t.length >> 1, i = n.length >> 1, o = new Array(a), c = 0;
            c < a;
            c++
          ) {
            for (var s = 1 / 0, g = 0, h = 0; h < i; h++) {
              for (var k = 0, f = 0, u = this.N >> 5; f < u; f++)
                k += tracking.Math.hammingWeight(r[c * u + f] ^ e[h * u + f]);
              k < s && ((s = k), (g = h));
            }
            o[c] = {
              index1: c,
        ...
        (tracking.Brief.reciprocalMatch = function(t, r, n, e) {
          ...
          for (
            ...
            o[i[c].index2].index2 === c && a.push(i[c]);
          return a;
        }),
        (tracking.Brief.getRandomOffsets_ = function(t) {
          if (!this.randomWindowOffsets_) {
            for (
              var r = 0, n = new Int32Array(4 * this.N), e = 0;
              e < this.N;
              e++
            )
          ...
          if (!this.randomImageOffsets_[t]) {
            for (
              var a = 0, i = new Int32Array(2 * this.N), o = 0;
              o < this.N;
              o++
            )
              (i[a++] =
      ...
      (tracking.ColorTracker = function(t) {
        ...
        (tracking.ColorTracker.prototype.mergeRectangles_ = function(t) {
          for (
            var r,
              n = [],
              e = this.getMinDimension(),
              a = this.getMaxDimension(),
              i = 0;
            i < t.length;
            i++
          ) {
        ...
        (tracking.ColorTracker.prototype.trackColor_ = function(n, e, a, i) {
          ...
          for (var y = 0; y < a; y++)
            for (var w = 0; w < e; w++)
              if (((p += 4), !u[p])) {
                for (
                  o = 0, h = -1, d[++h] = p, d[++h] = y, d[++h] = w, u[p] = 1;
                  h >= 0;
    ...
    (function() {
      (tracking.LandmarksTracker = function() {
        ...
        (tracking.LandmarksTracker.prototype.track = function(t, r, n) {
    ...
    (function() {
      (tracking.LBF = {}),
        (tracking.LBF.Regressor = function(t) {
          (this.maxNumStages = t),
        ...
        (tracking.LBF.Regressor.prototype.applyGlobalPrediction = function(
          ...
          for (
            var a = 2 * n[0].length, i = new Array(a / 2), o = 0;
            o < a / 2;
            o++
          )
            i[o] = [0, 0];
          for (var o = 0; o < n.length; o++) {
            for (var c = 0; c < a; c++) {
              for (var s = 0, g = 0, h = 0; (h = t[o][g].index) != -1; g++)
                h <= r[c].nr_feature && (s += r[c].data[h - 1] * t[o][g].value);
            ...
            var k = tracking.LBF.similarityTransform_(
              ...
              f = (tracking.Matrix.transpose(k[0]),
              tracking.LBF.unprojectShapeToBoundingBox_(n[o], e[o]));
            (f = tracking.Matrix.add(f, i)),
              (n[o] = tracking.LBF.projectShapeToBoundingBox_(f, e[o]));
          }
        }),
        (tracking.LBF.Regressor.deriveBinaryFeat = function(t, r, n, e, a) {
          ...
          for (var g = 1 << (t.maxDepth - 1), o = 0; o < r.length; o++) {
            for (
              var h = tracking.LBF.unprojectShapeToBoundingBox_(n[o], e[o]),
                k = tracking.LBF.similarityTransform_(h, a),
                s = 0;
              s < t.landmarkNum;
              s++
            )
            ...
            (i[o][t.landmarkNum * t.maxNumTrees].index = -1),
              (i[o][t.landmarkNum * t.maxNumTrees].value = -1);
          }
          return i;
        }),
    ...
    (function() {
      (tracking.LBF.maxNumStages = 4),
        ...
        (tracking.LBF.align = function(t, r, n, e) {
          ...
          for (var i in e) {
            ...
            (o.startX = e[i].x),
              ...
              (o.width = e[i].width),
              (o.height = e[i].height),
              (a[i] = tracking.LBF.regressor_.predict(t, r, n, o));
          }
          return a;
        }),
        (tracking.LBF.unprojectShapeToBoundingBox_ = function(t, r) {
          for (var n = new Array(t.length), e = 0; e < t.length; e++)
            n[e] = [
              (t[e][0] - r.startX) / r.width,
              (t[e][1] - r.startY) / r.height
            ];
          return n;
        }),
        (tracking.LBF.projectShapeToBoundingBox_ = function(t, r) {
          for (var n = new Array(t.length), e = 0; e < t.length; e++)
            n[e] = [t[e][0] * r.width + r.startX, t[e][1] * r.height + r.startY];
          return n;
        }),
        (tracking.LBF.similarityTransform_ = function(t, r) {
          for (var n = [0, 0], e = [0, 0], a = 0; a < t.length; a++)
            (n[0] += t[a][0]),
              (n[1] += t[a][1]),
              (e[0] += r[a][0]),
              (e[1] += r[a][1]);
          (n[0] /= t.length),
            ...
            (e[1] /= r.length);
          for (
            var i = tracking.Matrix.clone(t), o = tracking.Matrix.clone(r), a = 0;
            a < t.length;
            a++
          )
            (i[a][0] -= n[0]),
        ...
        (tracking.LBF.RandomForest = function(t) {
          (this.maxNumTrees = tracking.LBF.RegressorData[t].max_numtrees),
            (this.landmarkNum = tracking.LBF.RegressorData[t].num_landmark),
        ...
        (tracking.LBF.Tree = function(t, r, n) {
          ...
          (this.maxDepth = e.max_depth),
            ...
            (this.nodes = e.nodes),
            (this.landmarkID = e.landmark_id),
            (this.numLeafnodes = e.num_leafnodes),
            (this.numNodes = e.num_nodes),
            (this.maxNumFeats = e.max_numfeats),
            (this.maxRadioRadius = e.max_radio_radius),
            (this.leafnodes = e.id_leafnodes);
        });
    })();
