              ...
              var calculatedCallbacks = [],
                ...
                calculate = function() {
                  ...
                  if (oldImage && newImage) {
                    var zones = calculator.calculate(
                      oldImage,
                      newImage,
                      width,
                      height
            ...
            function WebCamFlow(defaultVideoTag, zoneSize, cameraFacing) {
              var videoTag,
                ...
                onWebCamFail = function onWebCamFail(e) {
                  if (e.code === 1) {
                    window.alert(
                      "You have denied access to your camera. I cannot do anything."
                    );
                  } else {
                    window.alert(
                ...
                initCapture = function() {
                  if (!videoFlow) {
                    videoTag =
                      defaultVideoTag || window.document.createElement("video");
                  ...
                  if (window.MediaStreamTrack.getSources) {
                    window.MediaStreamTrack.getSources(function(sourceInfos) {
                      ...
                      desiredDevice = {
                        optional: [{ sourceId: selectedVideoSource }]
                      };
                      ...
                      .then(function(sourceInfos) {
                        ...
                        navigator.getUserMedia(
                          ...
                          function(stream) {
                            ...
                            // depricated videoTag.src = window.URL.createObjectURL(stream);
                            if (stream) {
                              videoFlow.startCapture(videoTag);
                              videoFlow.onCalculated(gotFlow);
                            }
